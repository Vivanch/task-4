...
var validOption = [];
var score = 0;
var gameOver = 2; // 0 для поражения, 1 для победы, 2 для активации.
...
function SearchOption() {
    ...
    if (tdRow + 2 < 8 && tdCol + 1 < 8) //опция 1
    {
    ...
    if (tdRow + 2 < 8 && tdCol - 1 >= 0) //опция 2
    {
        var elem = "elem" + (tdRow + 2) + (tdCol - 1);
        if (document.getElementById(elem).style.backgroundColor != "yellow" &&
            document.getElementById(elem).style.backgroundColor != "blue") {
    ...
    if (tdRow + 1 < 8 && tdCol + 2 < 8) //опция 3
    {
    ...
    if (tdRow - 1 >= 0 && tdCol + 2 < 8) //опция 4
    {
        var elem = "elem" + (tdRow - 1) + (tdCol + 2);
        if (document.getElementById(elem).style.backgroundColor != "yellow" &&
            document.getElementById(elem).style.backgroundColor != "blue") {
    ...
    if (tdRow + 1 < 8 && tdCol - 2 >= 0) //опция 5
    {
        var elem = "elem" + (tdRow + 1) + (tdCol - 2);
        if (document.getElementById(elem).style.backgroundColor != "yellow" &&
            document.getElementById(elem).style.backgroundColor != "blue") {
    ...
    if (tdRow - 1 >= 0 && tdCol - 2 >= 0) //опция 6
    {
        var elem = "elem" + (tdRow - 1) + (tdCol - 2);
        if (document.getElementById(elem).style.backgroundColor != "yellow" &&
            document.getElementById(elem).style.backgroundColor != "blue") {
    ...
    if (tdRow - 2 >= 0 && tdCol + 1 < 8) //опция 7
    {
        var elem = "elem" + (tdRow - 2) + (tdCol + 1);
        if (document.getElementById(elem).style.backgroundColor != "yellow" &&
            document.getElementById(elem).style.backgroundColor != "blue") {
    ...
    if (tdRow - 2 >= 0 && tdCol - 1 >= 0) //опция 8
    {
        var elem = "elem" + (tdRow - 2) + (tdCol - 1);
        if (document.getElementById(elem).style.backgroundColor != "yellow" &&
            document.getElementById(elem).style.backgroundColor != "blue") {
...
function gameRestart() {
    ...
    validOption = [];
    score = 0;
    gameOver = 2; // 0 для поражения, 1 для победы, 2 для активации.
